...
def show_xception_layers(model):
    print("\n--- Xception Backbone Layers ---")
    model.get_layer("xception").summary()
    print("--------------------------------\n")

# --- Auto-detect last conv layer if not provided ---
def infer_last_conv_layer_name(model, backbone_name="xception"):
    """
    ...
    print("⚠️ Could not auto-detect last conv layer, falling back to 'block14_sepconv2_act'")
